...
import { LayoutGrid, Wrench } from 'lucide-react-native';
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.greetingSection}>
              ...
              <Text style={styles.descriptionText}>
                Manage your amenities, bookings, and society helpdesk.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.description}>
              We are working hard to bring you a premium experience for booking amenities, managing maintenance requests, and coordinating with your society helpdesk. Stay tuned!
            </Text>
